...
@Module({
  imports: [TypeOrmModule.forFeature([Person]), TypeOrmModule.forFeature([Role]),RoleModule],
  controllers: [PersonController],
  providers: [PersonService, JwtService, GraphApiService, UserAccessService, RoleService],
